      ...
      >
        <div className="relative">
          <Image
            ...
            width={400}
            height={400}
            className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-64 lg:h-64 object-contain opacity-90 transition-transform duration-300 group-hover:scale-110 drop-shadow-[0_0_15px_rgba(0,243,255,0.6)]"
            priority
          />
          {/* Glow behind the jet */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 bg-cyan-400/20 blur-2xl pointer-events-none rounded-full"></div>
        </div>
      </div>
    </>
  );
